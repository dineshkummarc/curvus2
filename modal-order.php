    ...
    <div id="add<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-body">
            ...
            <div class="span3">
               ...
               <p><center> <input id="cnet" class="span1" max="<?php echo $total_qty; ?>" type="number" name="quantity" value="1" required></center></p>
				<p><center><span class="badge badge-warning"><?php echo $total_qty; ?></span>&nbsp;&nbsp;Available Stock</center></p>

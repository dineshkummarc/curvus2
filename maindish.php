...
<div id="templatemo_wrapper_inner">
 ...
 <div id="menu_tab">
    ...
    <div id="templatemo_content_wrapper">          
        <div class="templatemo_side_bar margin_right_10">
            <img src="images/icons/bullet_go.png"/> Navigation: <span class="current">Main Dishes</span>
         <hr><br>
            <div class="header_01">We OFFERS</div>
               <ul>
                    ...
                    <li>
                        <span><a href="maindish.php"> Main Dish</a></span>
                    </li>

                     
                      <li>
                        <span><a href="desert.php"> Desert</a></span>
                    </li>
                     <li>
                        <span><a href="beverages.php"> Beverages</a></span>
                    </li>
 ...
 <ul class="thumbnails">
                            <center>
                             <?php
                            $query = mysql_query("select * from tb_products WHERE category = 'Main Dish'") or die(mysql_error());
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                       ...
                                       <center> <a href="#add<?php echo $id; ?>"  data-toggle="modal" class="btn btn-success">&nbsp;Reserve</a></center>
                                        ...
                                        <?php }else{ ?>
                                       <center> <span class="label label-important">Out Of Stock</span><center></p>
                                        <?php } ?>

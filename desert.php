...
<div id="templatemo_wrapper_inner">
 ...
 <div id="menu_tab">
    ...
    <div id="templatemo_content_wrapper">          
        <div class="templatemo_side_bar margin_right_10">
            <img src="images/icons/bullet_go.png"/> Navigation: <span class="current">Desert's</span>
         <hr><br>
 ...
 <ul class="thumbnails">
                            <center>
                             <?php
                            $query = mysql_query("select * from tb_products WHERE category = 'Desert'") or die(mysql_error());
